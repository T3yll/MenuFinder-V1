    ...
    <nav className="navbar-container shadow px-4 py-3">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          {!isLoggedIn ? (
            <>
              ...
              <Link
                to="/register"
                className="btn-outline py-2 px-4 rounded border"
              >
                S'inscrire
              </Link>
            </>
      ...
      {menuOpen && (
        <div className="md:hidden mt-4 flex flex-col space-y-3">
          ...
          <Link to="/restaurants" onClick={closeMenu} className="text-gray-700">
            Restaurants
          </Link>
          <Link to="/map" onClick={closeMenu} className="text-gray-700">
            Carte
          </Link>
          <CurrencySelector />
          {!isLoggedIn ? (
